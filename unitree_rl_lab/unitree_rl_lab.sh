...
export UNITREE_MODEL_DIR="${UNITREE_RL_LAB_PATH}/../unitree_model"
# current active scope:
# - Go2 agile locomotion in Isaac Lab
# - custom MoE training entrypoint: scripts/rsl_rl/train_moe.py
...
case "$1" in
    ...
    -m|--train-moe)
        shift
        ${python_exe} ${UNITREE_RL_LAB_PATH}/scripts/rsl_rl/train_moe.py --headless "$@"
        ;;
    *) # unknown option
        ;;
esac
